...
const BlogsContent = ({
  ...
  return (
    <div className="md:container xl:max-w-[1300px] 3xl:max-w-[1300px] flex flex-col items-center px-2 md:px-10 2xl:p-0 gap-12 min-h-screen mx-auto text-white my-4">
      ...
      <div id="tab-search" className="w-full xl:h-[72px] flex flex-col xl:flex-row md:gap-0 gap-5 justify-start lg:items-center md:justify-center xl:justify-between xl:bg-white/15 xl:backdrop-blur-0 p-2.5 xl:rounded-full xl:border xl:border-white/15">
        <TabBar />
