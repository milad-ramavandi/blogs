...
const CategoriesList = async ({
  ...
  return (
    <>
      <div className="bg-white/15 backdrop-blur-3xl border border-white/15 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow space-y-6 px-3 py-6 font-light">
        <span className="text-[20px] font-normal">All Category</span>
